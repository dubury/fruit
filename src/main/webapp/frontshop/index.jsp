...
<%@ page import="com.user.service.RecommendInfo" %>
...
<body>
<%
    RecommendInfo fi = new RecommendInfo();
    List<RecHotEntity> recommends = fi.recommend(request);
%>
<!--顶部导航-->
<div class="headr">
    <div class="heard-con">
            ...
            <div class="rec-right">
                ...
                <div class="bd">
                    ...
                    <div class="bd1" style="display: block">
                        <%
                            for (RecHotEntity recommend : recommends) {
                        %>
                        <div class="rcr">
                            <div class="rcr-top">
                                <img src="<%=recommend.getPic_path()%>" width="100%">
                            </div>
                            <div class="rcr-bot">
                                <div class="rb-top">
                                    <%=recommend.getName()%>
                                ...
                                <div class="second_P">
                                    ...
                                    <span class="fk-prop-price"><%=recommend.getPrice()%>
                                            <span class="fk-prop-p">.00</span>
                                        </span>
                                </div>
                                <div class="buy">
                                    <a class="second_mallBuy" href="../front/detail.do?id=<%=recommend.getId()%>">
