...
<%@ page import="com.user.service.HotInfo" %>
...
<%
    ...
    List<RecHotEntity> hots = hi.hot(request);
%>
<!--顶部导航-->
<div class="headr">
    <div class="heard-con">
        ...
        <div class="headr-nav">
            <ul>
                ...
                <li><a href="hot.jsp"><span style="color: #4AB344">蔬果热卖</span></a></li>
            ...
            <div class="rec-right">
                ...
                <div class="bd">
                    ...
                    <div class="bd1" style="display: block">
                        <%
                            for(RecHotEntity hot:hots){
                        %>
                        <div class="rcr">
                            <div class="rcr-top">
                                <img src="<%=hot.getPic_path()%>" width="100%">
                            </div>
                            <div class="rcr-bot">
                                <div class="rb-top">
                                    <%=hot.getName()%>
                                ...
                                <div class="second_P">
                                    ...
                                    <span class="fk-prop-price"><%=hot.getPrice()%>
                                            <span class="fk-prop-p">.00</span>
                                        </span>
                                </div>
                                <div class="buy">
                                    <a class="second_mallBuy" href="../front/detail.do?id=<%=hot.getId()%>">
