    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item"><a class="layui-this" href="add.jsp">添加商品</a></li>
            ...
            <div class="layui-col-lg12">
                <fieldset class="layui-elem-field" style="margin: 2em 15em;">
                    ...
                    <div class="layui-field-box">
                        <form class="layui-form" enctype="multipart/form-data" action="../bgfruit/save.do" method="post">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="name" required lay-verify="required" placeholder="请输入商品名称"
                                           autocomplete="off" class="picfile">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="purchase" required lay-verify="required" placeholder="请输入商品进价"
                                           autocomplete="off" class="picfile">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 5em;">
                                    <input type="text" name="quantity" required lay-verify="required" placeholder="请输入商品数量"
                                            autocomplete="off" class="picfile">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item" id="pic">
                                ...
                                <div class="picfile" style="width: 4em;">
                                    <input type="file" accept=".png,.jpg" name="main_pic" onchange="pic(this,0)" required />上传主图
                                </div>

                                <div class="picfile" style="width: 3.6em;">
                                    <input type="file" accept=".png,.jpg" name="sub_pic" onchange="pic(this,1)" required />详情图1
                                </div>

                                <div class="picfile" style="width: 3.6em;">
                                    <input type="file" accept=".png,.jpg" name="sub_pic" onchange="pic(this,2)" required />详情图2
                                </div>
                                <div class="picfile" style="width: 3.6em;">
                                    <input type="file" accept=".png,.jpg" name="sub_pic" onchange="pic(this,3)" required />详情图3
                                </div>

                                <div id="imgcontainer" class="layui-input-block">
                                    <img id="img0" width="100px" height="100px" style="display: none">
                                    <img id="img1" height="100px" style="display: none">
                                    <img id="img2" height="100px" style="display: none">
                                    <img id="img3" height="100px" style="display: none">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    ...
                                    <button type="button" onclick="location.reload()" class="layui-btn layui-btn-primary">重置</button>
                                </div>
                            </div>
                        </form>
                    </div>
